...
const commentcontainer_comentarii = document.getElementById('allComments');
...
function addComment(ev) {
    ...
    if(hasClass(ev.target.parentElement, 'container_comentarii')) {
        ...
        commentcontainer_comentarii.appendChild(wrapDiv);
    } else {
